...
namespace _26_TranGiaBao_Lab3.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(SignalrContext context, IHubContext<SignalrServer> signalRHub)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Products != null ?
                        ...
                        Problem("Entity set 'SignalrContext.Products'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SignalrContext.Products'  is null.");
            }
            var products = await _context.Products.FindAsync(id);
            if (products != null)
            {
